...
STAT_FONT = pygame.font.Font('04B_19.ttf', 40)
END_FONT = pygame.font.Font('04B_19.ttf', 40)
...
groundImage = pygame.transform.scale2x(pygame.image.load(os.path.join("imgs","base.png")).convert_alpha())
...
class Bird:
    ...
    def draw(self, win):
        ...
        blitRotateCenter(win, self.img, (round(self.x), round(self.y)), self.tilt)
